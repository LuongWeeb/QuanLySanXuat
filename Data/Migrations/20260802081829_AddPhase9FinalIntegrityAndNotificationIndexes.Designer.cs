...
namespace WmsMes.Web.Data.Migrations
{
    ...
    [Migration("20260802081829_AddPhase9FinalIntegrityAndNotificationIndexes")]
    partial class AddPhase9FinalIntegrityAndNotificationIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.AppNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.BOM", b =>
                {
                    ...
                    b.Property<decimal>("TotalStandardCost")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.CycleCountItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CycleCountOrderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CycleCountOrderId", "LocationId", "LotId")
                        .IsUnique();

                    b.ToTable("CycleCountItems");
                });

            modelBuilder.Entity("WmsMes.Web.Domain.Entities.CycleCountOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.PackingSlip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.PickList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.PickListItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.ProductionPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.ProductionPlanItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.PurchaseOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.PurchaseOrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.PurchaseRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("LowStockBatchKey")
                        .HasMaxLength(32)
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.PurchaseRequestItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.QCInspection", b =>
                {
                    ...
                    b.ToTable("QCInspections", t =>
                        {
                            t.HasCheckConstraint("CK_QCInspections_SourceMatchesType", "([Type] = 1 AND [GoodsReceiptId] IS NOT NULL AND [WorkOrderId] IS NULL) OR ([Type] = 2 AND [WorkOrderId] IS NOT NULL AND [GoodsReceiptId] IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.SalesOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.SalesOrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.WorkCenter", b =>
                {
                    ...
                    b.Property<decimal>("HourlyMachineRate")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.WorkOrder", b =>
                {
                    ...
                    b.Property<decimal?>("TargetLaborCost")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TargetMachineCost")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TargetMaterialCost")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.WorkOrderStep", b =>
                {
                    ...
                    b.HasIndex("WorkCenterId", "Status", "StartTime", "EndTime")
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.CycleCountItem", b =>
                {
                    b.HasOne("WmsMes.Web.Domain.Entities.CycleCountOrder", "CycleCountOrder")
                        .WithMany("Items")
                        .HasForeignKey("CycleCountOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.GoodsIssue", b =>
                {
                    ...
                    b.HasOne("WmsMes.Web.Domain.Entities.SalesOrder", "SalesOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.GoodsReceipt", b =>
                {
                    b.HasOne("WmsMes.Web.Domain.Entities.PurchaseOrder", "PurchaseOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.PickListItem", b =>
                {
                    ...
                    b.HasOne("WmsMes.Web.Domain.Entities.PickList", "PickList")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.ProductionPlanItem", b =>
                {
                    ...
                    b.HasOne("WmsMes.Web.Domain.Entities.ProductionPlan", "ProductionPlan")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("WmsMes.Web.Domain.Entities.PurchaseOrder", b =>
                {
                    b.HasOne("WmsMes.Web.Domain.Entities.PurchaseRequest", "PurchaseRequest")
                        .WithMany()
